<?php include 'header.php'; ?>
        ...
        <!--page title end-->
		    ...
		    <img src="assets/img/banners/responsive_web_development_bigperl_banner.png" alt="responsive_web_development_bigperl_banner" height="200" width="100%">
