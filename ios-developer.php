<?php include 'header.php'; ?>
        ...
        <!--page title end-->
		    ...
		    <img src="assets/img/banners/iOS_developer_bigperl_banner.png" alt="iOS_developer_bigperl_banner" height="200" width="100%">
