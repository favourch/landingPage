<?php include 'header.php'; ?>
        ...
        <!--page title end-->
		    ...
		    <img src="assets/img/banners/blackberry_app_development_bigperl_banner.png" alt="blackberry_app_development_bigperl_banner" height="200" width="100%">
