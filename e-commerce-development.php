		...
		<?php include 'header1.php' ?>
              ...
              <div class="container padding-top-20">
                  <div class="col-md-7">
                      ...
                      <ol>
                      <li>Our development team evaluates your online business objectives and offers100% unique solutions tailored to meet your exact e-commerce website requirements.</li>
                      <li>We deliver full-fledged e-commerce sites that are integrated with a number of elegant features, including taxation programs, shipping services, payment gateways, making your online business experience more convenient.</li>
                      <li>Cater exclusive solutions by implementing innovative ideas along with neat and clear coding under W3C standards. Guaranteed customer satisfaction with 24X7 availability through seamless communication channels.</li>
                      </ol>
                  </div>
