<?php include 'header.php'; ?>
        ...
        <!--page title end-->
		    ...
		    <img src="assets/img/banners/adf_and_webcenter_development_bigperl_banner.png" alt="adf_and_webcenter_development_bigperl_banner" height="200" width="100%">
