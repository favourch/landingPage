<?php include 'header.php'; ?>
        ...
        <!--page title end-->
		    ...
		    <img src="assets/img/banners/wearable_devices_bigperl_banner.png" alt="wearable_devices_bigperl_banner" height="200" width="100%">
              ...
              <div class="container padding-top-20">
                  <div class="col-md-7">
                      ...
                      <p>Bigperl Solution is the world’s fastest growing mobility complny , developed more than 1000 result-oriented mobile apps and games for businesses of all sorts and all scales across the world. Following successfully delivering cloud computing solutions, Bigperl solutions has stepped forward to create innovative wearable solutions to enhance your business performance.</p>
                      <p>We build robust, customizable wearable platform that can be used for developing business apps for Android, Apple, Sony, Google, Pebble, Puma, ARM, Fitbit, Philips, Samsung and other wearable devices. As an emerging wearable solution provider in India and the world, Bigperl Solutions delivers technology-driven wearable solutions to bring your business to the next level.</p>
                  </div>
