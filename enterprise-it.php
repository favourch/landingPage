<?php include 'header.php'; ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">enterprise it</li>
                        </ol>
                    </div>
                </div>
            </div>
		...
		<?php include 'header1.php' ?>
              ...
              <div class="row padding-top-20">
                  <div class="col-md-7">
                      <h2 class="text-bold mb-10">Enterprise App Distribution</h2>
